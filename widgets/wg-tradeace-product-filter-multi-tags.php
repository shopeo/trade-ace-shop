...
if (TRADEACE_WOO_ACTIVED) {
    ...
    add_action('widgets_init', 'tradeace_product_filter_tags_widget');

    function tradeace_product_filter_tags_widget() {
        register_widget('Trade_Ace_WC_Widget_Tags_Filter');
    }

    class Trade_Ace_WC_Widget_Tags_Filter extends WC_Widget {
        ...
        public function __construct() {
            $this->widget_cssclass = 'woocommerce widget_multi_tags_filter tradeace-any-filter tradeace-widget-has-active';
            $this->widget_description = esc_html__('Display a list of tags to filter products.', 'tradeace-theme');
            $this->widget_id = 'tradeace_woocommerce_multi_tags_filter';
            $this->widget_name = esc_html__('Tradeace Product Filter Multi Tags', 'tradeace-theme');
            $this->settings = array(
                'title' => array(
                    'type' => 'text',
                    'std' => esc_html__('Filter by Tags', 'tradeace-theme'),
        ...
        public function widget($args, $instance) {
            ...
            $tags = get_terms(apply_filters('tradeace_filter_tags_args', array(
		'number'     => 45,
		'taxonomy'   => 'product_tag',
                'orderby' => 'count',
                'order'   => 'DESC'
            ...
            extract($args);
            $this->_link = tradeace_get_origin_url();
            ...
            $output = '<div class="tradeace-filter-by-tags">';
