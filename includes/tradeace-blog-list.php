            ...
            <div class="<?php echo esc_attr($class_col); ?>">
                <div class="entry-content row">
                    <div class="large-12 columns">
                        ...
                        if ($categories_list) : ?>
                            <span class="cat-links-archive tradeace-archive-info first">
                    ...
                    <?php if ($show_author_info || $show_date_info || $show_comment) : ?>
                        <div class="large-12 columns text-left info-wrap tradeace-archive-info">
                    ...
                    <?php if ($post_type !== 'page' && $show_desc_blog) : ?>
                        <div class="large-12 columns entry-summary tradeace-archive-info"><?php the_excerpt(); ?></div>
                    <?php endif; ?>

                    <?php if ($show_readmore) : ?>
                        <div class="large-12 columns entry-readmore tradeace-archive-info">
