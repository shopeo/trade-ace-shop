...
$column_thumbs = isset($tradeace_opt['quick_view_item_thumb']) ? (int) $tradeace_opt['quick_view_item_thumb'] : 1;
$show_images = ($style_quickview == 'sidebar' && $attachment_ids && count($attachment_ids)) ?
    apply_filters('tradeace_quickview_number_imgs', $column_thumbs) : 1;
...
$attrs_main_img = apply_filters('tradeace_attrs_main_img_qv', array('class' => 'tradeace-first attachment-shop_single size-shop_single'));
...
<div class="row">
    ...
    <div class="<?php echo esc_attr($class); ?> product-quickview-img">
        <div class="product-img tradeace-product-gallery-lightbox" data-o_href="<?php echo $src_large; ?>">
            <?php
        ...
        <a class="tradeace-quickview-view-detail" href="<?php echo esc_url($link); ?>" title="<?php echo esc_attr($title); ?>">
            <?php echo esc_html__('VIEW DETAIL', 'tradeace-theme'); ?>
        </a>
    </div>
