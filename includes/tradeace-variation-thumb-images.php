...
<div class="product-thumbnails images-popups-gallery tradeace-single-product-thumbnails tradeace-thumbnail-default">
    <?php
    echo sprintf(
        '<div class="tradeace-wrap-item-thumb tradeace-active" data-main="#tradeace-main-image-0" data-key="0" data-thumb_org="%s"><a href="javascript:void(0);" data-current_img="%s" class="active-thumbnail" rel="nofollow"><img src="%s" %s/></a></div>',
        $src_thumb,
        $image_link,
        $src_thumb,
        $dimention
