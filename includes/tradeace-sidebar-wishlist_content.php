                ...
                <?php if ($countItems > 0) :
                    foreach ($wishlist_items as $item) :
                        ...
                        if ($product && $product->exists()) :
                            ...
                            ?>
                            <tr class="tradeace-tr-wishlist-item" id="yith-wcwl-row-<?php echo (int) $productId; ?>" data-row-id="<?php echo (int) $productId; ?>">
                                <td class="product-wishlist-info">
                                    <div class="wishlist-item-warper tradeace-relative">
                                        <div class="row wishlist-item">
                                            ...
                                            <div class="info-wishlist large-8 small-8 columns padding-right-0">
                                                <div class="row">
                                                    <div class="large-12 columns tradeace-wishlist-title">
                                                        <a href="<?php echo esc_url(get_permalink(apply_filters('woocommerce_in_cart_product', $productId))); ?>">
                                                    ...
                                                    <?php if (!isset($tradeace_opt['disable-cart']) || !$tradeace_opt['disable-cart']) :?>
                                ...
                                <?php if ($is_user_owner) : ?>
                                    <td class="product-remove">
                                        <a href="javascript:void(0);" class="remove tradeace-remove_from_wishlist tradeace-stclose" title="<?php esc_attr_e('Remove this product', 'tradeace-theme'); ?>" data-logined="<?php echo (int) TRADEACE_CORE_USER_LOGGED; ?>" data-prod_id="<?php echo (int) $productId; ?>" rel="nofollow">
                    ...
                    <tr class="pagination-row">
                        <td class="wishlist-empty"><p class="empty"><i class="tradeace-empty-icon icon-tradeace-like"></i><?php esc_html_e('No products in the wishlist.', 'tradeace-theme') ?><a href="javascript:void(0);" class="button tradeace-sidebar-return-shop" rel="nofollow"><?php echo esc_html__('RETURN TO SHOP', 'tradeace-theme'); ?></a></p></td>
                    </tr>
                <?php
                endif;
        ...
        <tbody>
            <?php if ($countItems > 0) :
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="wishlist-price large-12 columns">
                                                    ...
                                                    if ($show_stock_status) :
                                                        if ($stock_status == 'out-of-stock') :
                                                            echo '<span class="wishlist-out-of-stock">' . esc_html__(' - Out of Stock', 'tradeace-theme') . '</span>';
                                                        else :
                                                            echo '<span class="wishlist-in-stock">' . esc_html__(' - In Stock', 'tradeace-theme') . '</span>';
                                                        endif;
                ...
                if ($wishlist_page_id) :
                    ...
                    <tr>
                        <td colspan="2">
                            <a href="<?php echo esc_url(get_permalink($wishlist_page_id)); ?>" class="button tradeace-wishlist-page tradeace-block margin-top-20"><?php echo esc_html__('Wishlist Page', 'tradeace-theme'); ?></a>
                        </td>
                    </tr>
                <?php endif;
            else: ?>
