...
if (!WC()->cart->is_empty()) :
    ...
    ?>
    <div class="tradeace-minicart-items">
            ...
            foreach ($cart_items as $cart_item_key => $cart_item) :
                ...
                if ($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key)) :
                    ...
                    <div class="row mini-cart-item woocommerce-mini-cart-item <?php echo esc_attr(apply_filters('woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key)); ?>">
                        <div class="small-3 large-3 columns tradeace-image-cart-item padding-left-0 padding-right-0 rtl-right">
                            <?php echo $thumbnail; ?>
                        </div>

                        <div class="small-7 large-8 columns tradeace-info-cart-item padding-left-15 padding-right-0 rtl-padding-left-0 rtl-padding-right-15 rtl-right">
                            <div class="mini-cart-info">
                                ...
                                $wrap = false;
                                $quantily_show = true;
                                if ((!isset($tradeace_opt['mini_cart_qty']) || $tradeace_opt['mini_cart_qty'])) :
                                    $quantily_show = false;
                        ...
                        <div class="small-2 large-1 columns product-remove padding-left-0 padding-right-0 text-right rtl-text-left">
                            ...
                            echo apply_filters('woocommerce_cart_item_remove_link',
                                sprintf(
                                    '<a href="%s" class="remove remove_from_cart_button item-in-cart tradeace-stclose" aria-label="%s" data-product_id="%s" data-cart_item_key="%s" data-product_sku="%s" title="%s">%s</a>',
    ...
    <div class="tradeace-minicart-footer">
        <div class="minicart_total_checkout woocommerce-mini-cart__total total">
             ...
             * @hooked tradeace_widget_shopping_cart_subtotal - 10
             * @hooked tradeace_subtotal_free_shipping - 15
             */
 ...
 */
    ...
    echo '<p class="empty woocommerce-mini-cart__empty-message"><i class="tradeace-empty-icon ' . $icon_class . '"></i>' . esc_html__('No products in the cart.', 'tradeace-theme') . '<a href="javascript:void(0);" class="button tradeace-sidebar-return-shop" rel="nofollow">' . esc_html__('RETURN TO SHOP', 'tradeace-theme') . '</a></p>';
endif;
