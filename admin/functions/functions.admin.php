 ...
 * Get Menu Options
 */
function tradeace_admin_get_menu_options() {
    $menus = function_exists('tradeace_meta_get_list_menus') ?
        tradeace_meta_get_list_menus() : array();
 ...
 * Get static Blocks
 */
function tradeace_admin_get_static_blocks() {
    $static_blocks = array('default' => esc_html__('Select the Static Block', 'tradeace-theme'));
    
    $tradeace_blocks = function_exists('tradeace_get_blocks_options') ?
        tradeace_get_blocks_options() : array();

    if (isset($tradeace_blocks[''])) {
        unset($tradeace_blocks['']);
    }

    if (isset($tradeace_blocks['-1'])) {
        unset($tradeace_blocks['-1']);
    }
    
    if (!empty($tradeace_blocks)) {
        foreach ($tradeace_blocks as $key => $value) {
 ...
 * Get Footer Builder
 */
function tradeace_admin_get_footer_builder() {
    $footers_builder = function_exists('tradeace_get_footers_options') ?
        tradeace_get_footers_options() : array();
 ...
 */
function tradeace_admin_get_footer_elementor() {
    $footers = function_exists('tradeace_get_footers_elementor') ?
        tradeace_get_footers_elementor() : array();
 ...
 * Get Header Builder
 */
function tradeace_admin_get_header_builder() {
    $headers_builder = function_exists('tradeace_get_headers_options') ?
        tradeace_get_headers_options() : array();
 ...
 * Get cats
 */
function tradeace_get_cats_array() {
    $categories = get_categories(array(
        'taxonomy' => 'category',
        'orderby' => 'name'
    ));
    $list = array(
        '' => esc_html__('Select category', 'tradeace-theme')
    );
 ...
 */
 ...
 if(!function_exists('tradeace_get_google_fonts'))
 {
function tradeace_get_google_fonts() {
...
if (!isset($tradeace_list_icons)) {
    $tradeace_list_icons = array(
        '' => array(
            "icon-tradeace-headphone",
            "icon-tradeace-headset",
            "icon-tradeace-icons-4",
            "icon-tradeace-cart",
            "icon-tradeace-cart-2",
            "icon-tradeace-cart-3",
            "icon-tradeace-cart-4",
            "icon-tradeace-refresh",
            "icon-tradeace-compare",
            "icon-tradeace-compare-1",
            "icon-tradeace-compare-2",
            "icon-tradeace-compare-3",
            "icon-tradeace-compare-4",
            "icon-tradeace-compare-5",
            "icon-tradeace-like",
            "icon-tradeace-liked",
            "icon-tradeace-wishlist",
            "icon-tradeace-like-love-streamline",
            "icon-tradeace-1column",
            "icon-tradeace-2column",
            "icon-tradeace-3column",
            "icon-tradeace-4column",
            "icon-tradeace-5column",
            "icon-tradeace-6column",
            "icon-tradeace-list",
            "icon-tradeace-icons-17",
            "icon-tradeace-icons-18",
            "icon-tradeace-icons-19",
            "icon-tradeace-icons-21",
            "icon-tradeace-icons-menu",
            "icon-tradeace-icons-1",
            "icon-tradeace-icons-6",
            "icon-tradeace-sale",
            "icon-tradeace-sale-1",
            "icon-tradeace-sale-2",
            "icon-tradeace-like-hand",
            "icon-tradeace-car",
            "icon-tradeace-car-1",
            "icon-tradeace-car-2",
            "icon-tradeace-location",
            "icon-tradeace-credit",
            "icon-tradeace-icons-15",
            "icon-tradeace-99",
            "icon-tradeace-search",
            "icon-tradeace-if-search",
            "icon-tradeace-left-arrow",
            "icon-tradeace-right-arrow",
            "icon-tradeace-icons-8",
            "icon-tradeace-icons-10",
            "icon-tradeace-icons-11",
            "icon-tradeace-icons-12-1",
            "icon-tradeace-expand",
            "icon-tradeace-play",
            "icon-tradeace-close",
            "icon-tradeace-close-1",
            "icon-tradeace-close-2",
            "icon-tradeace-icons-12",
            "icon-tradeace-99-1",
            "icon-tradeace-mouse",
            "icon-tradeace-computer",
            "icon-tradeace-check",
            "icon-tradeace-check-1",
            "icon-tradeace-icons-plus",
            "icon-tradeace-icons-minus",
            "icon-tradeace-fruit",
            "icon-tradeace-diet",
            "icon-tradeace-orange",
            "icon-tradeace-parsley",
            "icon-tradeace-onion",
            "icon-tradeace-banana",
            "icon-tradeace-potatoes",
            "icon-tradeace-raspberry",
            "icon-tradeace-healthy-food",
            "icon-tradeace-meat",
            "icon-tradeace-fish",
            "icon-tradeace-fast-food",
            "icon-tradeace-tomato"
        ),
...
add_action('admin_head', 'tradeace_style_script');
function tradeace_style_script() {
    echo '<script>var ajaxurl="' . esc_url(admin_url('admin-ajax.php')) . '";</script>';
    wp_enqueue_style('wp-color-picker');
    wp_register_style('tradeace-style', TRADEACE_THEME_URI . '/admin/assets/css/tradeace-style.css');
    wp_enqueue_style('tradeace-style');
    wp_enqueue_script('wp-color-picker');
    wp_enqueue_script('tradeace-script', TRADEACE_THEME_URI . '/admin/assets/js/tradeace-script.js', array(), null, true);
    tradeace_add_font_custom_admin();
}

// **********************************************************************// 
// ! Add Font Awesome, Font Pe7s, Font Elegant
// **********************************************************************// 
function tradeace_add_font_custom_admin() {
    wp_register_style('tradeace-font-awesome-style', TRADEACE_THEME_URI . '/assets/font-awesome-4.7.0/css/font-awesome.min.css');
    wp_enqueue_style('tradeace-font-awesome-style');
    wp_register_style('tradeace-font-pe7s-style', TRADEACE_THEME_URI . '/assets/font-pe-icon-7-stroke/css/pe-icon-7-stroke.css');
    wp_enqueue_style('tradeace-font-pe7s-style');
    wp_register_style('tradeace-font-tradeace-style', TRADEACE_THEME_URI . '/assets/font-tradeace/tradeace-font.css');
    wp_enqueue_style('tradeace-font-tradeace-style');
}

add_action('wp_ajax_tradeace_list_fonts_admin', 'tradeace_list_fonts_admin');
function tradeace_list_fonts_admin() {
    global $tradeace_list_icons;
    ?>
    <div class="tradeace-list-icons-select" data-fill="<?php echo esc_attr($_REQUEST['fill']); ?>">
        <input name="search-icons" value="" class="tradeace-input-search-icon" placeholder="<?php echo esc_attr__('Search icon', 'tradeace-theme'); ?>" />
        
        <?php do_action('tradeace_before_list_icons_admin'); ?>
        
        <h3><?php echo esc_html__('Font Tradeace icons', 'tradeace-theme'); ?></h3>
        <?php foreach ($tradeace_list_icons['tradeace'] as $font) : ?>
            <a class="tradeace-fill-icon tradeace-font-icon tradeace-font-icons" href="javascript:void(0);" data-val="tradeace-icon <?php echo esc_attr($font); ?>" data-text="tradeace-icon <?php echo esc_attr($font); ?>"><i class="<?php echo esc_attr($font); ?>"></i></a>
        <?php endforeach; ?>

        <hr />
        <h3><?php echo esc_html__('Fontawesome icons', 'tradeace-theme'); ?></h3>
        <?php foreach ($tradeace_list_icons['fa'] as $font) : ?>
            <a class="tradeace-fill-icon tradeace-fa-icon tradeace-font-icons" href="javascript:void(0);" data-val="fa <?php echo esc_attr($font); ?>" data-text="<?php echo esc_attr($font); ?>"><i class="fa <?php echo esc_attr($font); ?>"></i></a>
        <?php endforeach; ?>
        
        <hr />
        <h3><?php echo esc_html__('Pe7s icons', 'tradeace-theme'); ?></h3>
        <?php foreach ($tradeace_list_icons['pe'] as $font) : ?>
            <a class="tradeace-fill-icon tradeace-pe7-icon tradeace-font-icons" href="javascript:void(0);" data-val="pe7-icon <?php echo esc_attr($font); ?>" data-text="<?php echo esc_attr($font); ?>"><i class="<?php echo esc_attr($font); ?>"></i></a>
        <?php endforeach; ?>
            
        <?php do_action('tradeace_after_list_icons_admin'); ?>
 ...
 */
add_action('wp_ajax_tradeace_check_instagram_token', 'tradeace_check_instagram_token');
function tradeace_check_instagram_token() {
    ...
    if (!is_wp_error($result)) {
        ...
        if (isset($data->data->id)) {
            ...
            $output .= '<div>' . esc_html__('Username:', 'tradeace-theme') . ' <strong>' . $data->data->username . "</strong></div>";
            $instagramInfo = array(
                'id' => $data->data->id,
...
function get_pages_temp_compare() {
    ...
    $pages_compare = array('' => esc_html__('Select page view compare', 'tradeace-theme'));
    if ($pages) {
...
function get_pages_temp_portfolio() {
    ...
    $portfolio = array('' => esc_html__('Select page view Portfolio', 'tradeace-theme'));
    if ($pages) {
        foreach ($pages as $page) {
 ...
 * Get custom fonts
 */
 if(!function_exists('tradeace_get_custom_fonts'))
 {
function tradeace_get_custom_fonts() {
    return array();
}
 }
 ...
 * Add new custom font
 */
add_action('init', 'tradeace_add_new_custom_font', 1);
function tradeace_add_new_custom_font() {
    $result = array('success' => false);
    
    if (!current_user_can('manage_options')) {
        $result['mess'] = esc_html__("Access denied.", 'tradeace-theme');
        return $result;
    }
    
    if (!isset($_FILES['zip_packet_font'])) {
        $result['mess'] = esc_html__("Require ZIP file.", 'tradeace-theme');
        return $result;
    }
    ...
    if (!in_array($type, $accepted_types)) {
        $result['mess'] = esc_html__("The file you are trying to upload is not a .zip file. Please try again.", 'tradeace-theme');
        return $result;
    }
    ...
    global $wp_filesystem, $tradeace_upload_dir;
    ...
    add_filter('upload_dir', 'tradeace_base_upload_dir_zip');
    $uploadZip = wp_handle_upload($_FILES['zip_packet_font']);
    remove_filter('upload_dir', 'tradeace_base_upload_dir_zip');
    
    if ($uploadZip) {
        $checkDir = $tradeace_upload_dir['basedir'] . '/tradeace-check-custom-fonts';
        ...
        if ($unzip_test) {
            ...
            $font_dir = $tradeace_upload_dir['basedir'] . '/tradeace-custom-fonts';
            ...
            $result['success'] = true;
            $result['mess'] = esc_html__("Upload new custom font success!", 'tradeace-theme');
        }
    }
 ...
 * @return  array
 */
function tradeace_base_upload_dir_zip($dir) {
    return array(
        'path'   => $dir['basedir'] . '/tradeacetheme-tmp',
        'url'    => $dir['baseurl'] . '/tradeacetheme-tmp',
        'subdir' => '/tradeacetheme-zip',
    ) + $dir;
}

/* Remove Tabs - Accordions elements */
add_action('vc_build_admin_page', 'tradeace_vc_remove_elements_default', 11);
function tradeace_vc_remove_elements_default() {
