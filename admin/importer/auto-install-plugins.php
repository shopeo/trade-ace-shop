...
class Trade_Ace_Auto_Install_Plugins extends TGM_Plugin_Activation {
    protected $slug_plg = '';
     ...
     * @return type
     */
    public function tradeace_plugin_install() {
        /**
         * Check plugin installed
         */
        if ($this->is_plugin_installed($this->slug_plg)) {
            return $this->tradeace_plugin_active();
        }
        ...
        $skin_args = array(
            ...
            'title' => esc_html__('Installing Plugin', 'tradeace-theme'),
            'url' => esc_url_raw($url),
        ...
        return $result ? $this->tradeace_plugin_active() : false;
    }
    
    /**
     * Active Plugin
     */
    public function tradeace_plugin_active() {
