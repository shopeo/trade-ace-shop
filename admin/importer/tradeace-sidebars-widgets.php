<?php
function tradeace_sidebars_widgets_import() {
    $results = array(
        'sidebars_widgets' => array(
            ...
            'shop-sidebar' => array(
                0 => 'tradeace_product_categories-2',
                1 => 'tradeace_woocommerce_filter_variations-2',
                2 => 'tradeace_woocommerce_filter_variations-3',
                3 => 'tradeace_woocommerce_price_filter-2',
                4 => 'tradeace_woocommerce_status_filter-2',
                5 => 'tradeace_woocommerce_reset_filter-2',
            ),
            
            'product-sidebar' => array(
                0 => 'tradeace_product_categories-3',
                1 => 'tradeace_tag_cloud-2'
            )
        ),
        ...
        'widgets' => array(
            ...
            'widget_tradeace_product_categories' => array(
                2 => array(
                    'title' => 'Categories',
                    'orderby' => 'order',
                    'count' => 0,
            ...
            'widget_tradeace_woocommerce_filter_variations' => array(
                2 => array(
                    'title' => 'Color',
                    'attribute' => 'color',
                    'query_type' => 'or',
            ...
            'widget_tradeace_woocommerce_price_filter' => array(
                2 => array(
                    'title' => 'Price',
                    'btn_filter' => 0,
                ),
            ...
            'widget_tradeace_woocommerce_status_filter' => array(
                2 => array(
                    'title' => 'Status',
                    'filter_onsale' => 1,
                    'filter_featured' => 1,
            ...
            'widget_tradeace_woocommerce_reset_filter' => array(
                2 => array(
                    'title' => 'Clear Filters'
                ),
                '_multiwidget' => 1
            ...
            'widget_tradeace_tag_cloud' => array(
                2 => array(
                    'title' => 'Tags',
    ...
    if (TRADEACE_ELEMENTOR_ACTIVE) {
        ...
        $results['widgets']['widget_tradeace_image'] = array(
            2 => array(
                'alt' => 'Logo Footer',
                'link_text' => '#',
                'link_target' => '',
        ...
        $results['widgets']['widget_tradeace_follow'] = array(
            2 => array(
                'title' => '',
                'twitter' => '',
                'facebook' => '',
        ...
        $results['widgets']['widget_tradeace_menu_sc'] = array(
            2 => array(
                'title' => '',
                'menu' => 'customer-care',
                'el_class' => '',
            ...
            8 => array(
                'title' => '',
                'menu' => 'footer-menu',
                'el_class' => 'tradeace-menu-inline text-center',
            ),
            9 => array(
                'title' => '',
                'menu' => 'footer-menu',
        ...
        $results['widgets']['widget_text'] = array(
            ...
            3 => array(
                'title' => '',
                'text' => '<p class="margin-bottom-0">© 2020 <strong>Tradeacetheme</strong> - All Right reserved!</p>',
                'filter' => true,
                'visual' => true,
            ),
            4 => array(
        ...
        $results['widgets']['widget_custom_html'] = array(
            ...
            6 => array(
                'title' => '',
                'content' => '<p class="tradeace-contact-text">Get instant updates about our new products and special promos!</p>',
            ),
            7 => array(
                'title' => '',
                'content' => '[contact-form-7 id="210" title="Trade_Ace Newsletter Form Footer"]',
            ),
            8 => array(
                'title' => '',
                'content' => '<p>© 2020 <strong>Tradeacetheme</strong> - All Right reserved!</p>',
            ),
            9 => array(
                'title' => '',
                'content' => '<ul class="contact-information text-center margin-bottom-0 margin-top-20"><li class="media"><div class="contact-text">Calista Wise 7292 Dictum Av.Antonio, Italy.</div></li><li class="media"><div class="contact-text">(+01)-800-3456-88</div></li><li class="media"><div class="contact-text"><a href="mailto:youremail@yourdomain.com" title="Email">youremail@yourdomain.com</a></div></li><li class="media"><div class="contact-text"><a href="http://www.yourdomain.com" title="www.yourdomain.com">www.yourdomain.com</a></div></li></ul><p class="text-center padding-top-10 padding-bottom-10">© 2020 <strong>Tradeacetheme</strong> - All Right reserved!</p>',
            ),
            10 => array(
                'title' => '',
                'content' => '<ul class="contact-information"><li class="media"><div class="contact-text">Cecilia Chapman 711-2880 Nulla St</div></li><li class="media"><div class="contact-text">(+01)-800-3456-88</div></li><li class="media"><div class="contact-text"><a href="mailto:youremail@yourdomain.com" title="Email">youremail@yourdomain.com</a></div></li><li class="media"><div class="contact-text"><a href="http://yourdomain.com" title="www.yourdomain.com">www.yourdomain.com</a></div></li></ul>',
            ...
            12 => array(
                'title' => '',
                'content' => '<ul class="tradeace-opening-time"><li><span class="tradeace-day-open">Monday - Friday</span><span class="tradeace-time-open">08:00 - 20:00</span></li><li><span class="tradeace-day-open">Saturday</span><span class="tradeace-time-open">09:00 - 21:00</span></li><li><span class="tradeace-day-open">Sunday</span><span class="tradeace-time-open">13:00 - 22:00</span></li></ul>',
            ),
            13 => array(
                'title' => '',
                'content' => '<p>© 2020 <strong>Tradeacetheme</strong> - All Right reserved!</p>',
	...
	<div class="large-3 tradeace-service-footer tradeace-col columns">
		[tradeace_service_box service_icon="pe-7s-plane" service_title="Free Shipping" service_desc="Free shipping for all US order" service_style="style-4" service_hover="buzz_effect"]
	</div>
	<div class="large-3 tradeace-service-footer tradeace-col columns">
		[tradeace_service_box service_icon="pe-7s-headphones" service_title="Support 24/6" service_desc="We support 24 hours a day" service_style="style-4" service_hover="buzz_effect"]
	</div>
	<div class="large-3 tradeace-service-footer tradeace-col columns">
		[tradeace_service_box service_icon="pe-7s-refresh-2" service_title="100% Money Back" service_desc="You have 30 days to return" service_style="style-4" service_hover="buzz_effect"]
	</div>
	<div class="large-3 tradeace-service-footer tradeace-col columns">
		[tradeace_service_box service_icon="pe-7s-gift" service_title="Payment Secure" service_desc="We ensure secure payment" service_style="style-4" service_hover="buzz_effect"]
	</div>
</div>',
            ),
            15 => array(
