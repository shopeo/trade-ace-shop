...
if (!/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent)) {
    jQuery(function ($) {
        $elements = $('.tradeace-banner, .tradeace_bg, .parallax_img').find('[data-velocity]');

        var topOffset = $('#header-content').outerHeight() + $('#wpadminbar').outerHeight();

        $(window).on('resize.tradeace-parallax', function () {
            var windowHeight = $(window).height();
            var scrollTop = $(window).scrollTop();
            $elements.each(function (i) {
                var $this = $(this);
                var $banner = $this.parents('.tradeace-banner, .tradeace_bg, .parallax_img');
            ...
            $(window).trigger('scroll.tradeace-parallax');
        });

        $(window).on('scroll.tradeace-parallax', function () {
            var windowHeight = $(window).height();
            var scrollTop = $(window).scrollTop();
        ...
        $(window).on("DOMNodeInserted", function (e) {
            $(window).trigger('resize.tradeace-parallax');
        });
