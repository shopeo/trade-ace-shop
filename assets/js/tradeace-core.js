...
function loading_slick_element($, restart) {
    if ($('.tradeace-slick-slider').length) {
        ...
        $('.tradeace-slick-slider').each(function() {
             ...
             * Remove slick item
             */
            if ($(_this).find('.tradeace-slick-remove').length) {
                $(_this).find('.tradeace-slick-remove').remove();
            }
            ...
            if (!$(_this).hasClass('slick-initialized')){
                ...
                var _setting = {
                    ...
                    touchThreshold: 10,
                    cssEase: 'ease-out',
                    prevArrow: '<a class="tradeace-nav-arrow slick-prev" href="javascript:void(0);"></a>',
                    nextArrow: '<a class="tradeace-nav-arrow slick-next" href="javascript:void(0);"></a>'
                };
                ...
                if (_padding) {
                    ...
                    if (!$(_this).hasClass('tradeace-center-mode')) {
                        $(_this).addClass('tradeace-center-mode');
                    }
                }
                ...
                if (_padding_small) {
                    ...
                    if (!$(_this).hasClass('tradeace-small-center-mode')) {
                        $(_this).addClass('tradeace-small-center-mode');
                    }
                } else {
                ...
                if (_padding_medium) {
                    ...
                    if (!$(_this).hasClass('tradeace-medium-center-mode')) {
                        $(_this).addClass('tradeace-medium-center-mode');
                    }
                } else {
                 ...
                 */
                if ($(_this).find('.tradeace-banner-image').length) {
                ...
                setTimeout(function() {
                    $('body').trigger('tradeace_inited_slick', [_this]);
                }, 100);
            }
        });
    }
 ...
 * @type type
 */
function tradeace_compatible_jetpack($) {
