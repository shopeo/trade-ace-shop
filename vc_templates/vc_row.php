...
global $tradeace_opt;
if ($hide_in_mobile && isset($tradeace_opt['tradeace_in_mobile']) && $tradeace_opt['tradeace_in_mobile']) {
    ...
    if (!empty($equal_height)) {
        $css_classes[] = 'tradeace-row-cols-equal-height';
    }
    ...
    if ($has_video_bg) {
        ...
        $css_classes[] = 'vc_video-bg-container tradeace-relative';
    ...
    if ($base_row === 'vc_row'){
        ...
        $output .= ($fullwidth == '1') ? '<div class="tradeace-row fullwidth clearfix">' : '<div class="row">';
