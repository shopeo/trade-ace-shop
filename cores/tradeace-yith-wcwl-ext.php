 ...
 */
if (TRADEACE_WISHLIST_ENABLE && class_exists('YITH_WCWL_Shortcode')) :

    class TRADEACE_YITH_WCWL_Shortcode extends YITH_WCWL_Shortcode {
        ...
        public static function init() {
            if (!TRADEACE_WISHLIST_NEW_VER) {
                add_shortcode('tradeace_yith_wcwl_wishlist', array('TRADEACE_YITH_WCWL_Shortcode', 'wishlist'));
            } else {
                add_shortcode('tradeace_yith_wcwl_wishlist', array('TRADEACE_YITH_WCWL_Shortcode', 'wishlist_new'));
            }
            
            add_filter('yith_wcwl_localize_script', array('TRADEACE_YITH_WCWL_Shortcode', 'tradeace_yith_wcwl_localize_script'));
        }
         ...
         * @return type
         */
        public static function tradeace_yith_wcwl_localize_script($localize_script) {
        ...
        public static function wishlist($atts = array(), $content = null) {
            ...
            ob_start();
            $template = TRADEACE_CHILD_PATH . '/includes/tradeace-sidebar-wishlist_content.php';
            include is_file($template) ? $template : TRADEACE_THEME_PATH . '/includes/tradeace-sidebar-wishlist_content.php';
            ...
            return apply_filters('tradeace_yith_wcwl_wishlisth_html', $content_wishlist, array(), true);
        }
    ...
    TRADEACE_YITH_WCWL_Shortcode::init();
endif;
